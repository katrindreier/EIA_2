var L09_Unterwasserwelt;
(function (L09_Unterwasserwelt) {
    ...
    function init(_event) {
        ...
        //Algen
        for (let i = 0; i < 7; i++) {
            let xrandomAlge = Math.random() * crc2.canvas.width; //x Zufällige Stelle wo das Element platziert wird
        ...
        //Fkt Sand
        for (let i = 0; i < 200; i++) {
            var xSand = Math.random() * crc2.canvas.width; //x Zufällige Stelle wo das Element platziert wird
            var ySand = (Math.random() * crc2.canvas.height * 0.2) + crc2.canvas.height * 0.8; //y
            let radius = Math.random() * 3;
            drawSand(xSand, ySand, radius);
        }
        //Fkt Fische 
        for (let i = 0; i < 10; i++) {
            var xFish = Math.random() * crc2.canvas.width; //x Zufällige Stelle wo das Element platziert wird
            var yFish = Math.random() * crc2.canvas.height * 0.7; //y
            let direction;
            let num = Math.random();
            let color;
            if (num >= 0.5) {
        ...
        //Fkt bubbles 
        for (let i = 0; i < 20; i++) {
            let xWater = Math.random() * crc2.canvas.width; //x Zufällige Stelle wo das Element platziert wird
            let yWater = Math.random() * crc2.canvas.height * 0.9; //y
            let radius = Math.random() * 20;
            drawBubbles(xWater, yWater, radius); //Funktionsaufruf Element zeichnen
        }
    }
    function drawBubbles(xWater, yWater, radius) {
    ...
    function drawFish(xFish, yFish, direction, color) {
        if (direction == false) {
            //Fischkörper
...
})(L09_Unterwasserwelt || (L09_Unterwasserwelt = {}));
